...
type SOAPBodyRequest struct {
	...
	CapitalCity *CapitalCity `xml:,omitempty`
}
...
type SOAPBodyResponse struct {
	...
	CapitalCityResponse *CapitalCityResponse `xml:",omitempty"`
}

func (service *SOAPBodyRequest) GetInfoFunc(request *CapitalCity) (*CapitalCityResponse, error) {
	return &CapitalCityResponse{
		CapitalCityResult: "gowsdl, " + request.SCountryISOCode,
	}, nil
}
